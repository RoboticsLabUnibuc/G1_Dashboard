#!/usr/bin/env python3
"""Quest hand-tracking -> Inspire DFX finger-only test V4 for Unitree G1 PC2.
...
def main() -> int:
    ...
    try:
        ...
        # Do not call sshkeyboard.stop_listening() here. On this Jetson
        # runtime it can block indefinitely after q even though the listener
        # thread was created as a daemon. The os._exit() below terminates the
        # standalone process deterministically after all-open commands and
        # TeleVuer child cleanup have completed.
        LOG.info("Shutdown cleanup complete; terminating process.")
