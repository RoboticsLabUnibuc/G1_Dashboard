...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "~/g1_setup_logs/xr_v6_7_diag_<timestamp>.csv"
        ),
    )
    return parser
...
def main() -> int:
    ...
    try:
        ...
        LOG.info("G1_LOCOMOTION_XR_HANDOVER_LIVE_V6_7_1_DIRECT_HANDOFF_PORT_RESTART_FIX")
        LOG.warning(
        ...
        diagnostic_path = (
            ...
            / "g1_setup_logs"
            / f"xr_v6_7_diag_{time.strftime('%Y%m%d_%H%M%S')}.csv"
        )
