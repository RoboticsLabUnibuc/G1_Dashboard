...
if __name__ == '__main__':
    ...
    try:
        ...
        # STAGED_ARM_MOVEMENT_V1
        arm_ctrl.arm_velocity_limit = 0.50
        logger_mp.info(
            "Arm translation gain = 0.40; "
            "joint velocity limit = 0.50 rad/s."
        )
        head_img = None
        left_wrist_img = None
        ...
        arm_position_gain = 0.40  # staged robot-arm translation gain
        while not STOP:
