#!/usr/bin/env python3
"""Live G1 Regular-mode locomotion <-> XR arm handover (V6.7 direct handoff + stable re-entry).
...
def main() -> int:
    ...
    try:
        ...
        LOG.info("G1_LOCOMOTION_XR_HANDOVER_LIVE_V6_7_DIRECT_HANDOFF_STABLE_REENTRY")
        LOG.warning(
