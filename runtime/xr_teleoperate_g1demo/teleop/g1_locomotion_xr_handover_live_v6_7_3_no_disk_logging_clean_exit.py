#!/usr/bin/env python3
"""Live G1 Regular-mode locomotion <-> XR arm handover (V6.7.1 direct handoff + stable re-entry + port restart fix).
...
def main() -> int:
    ...
    try:
        ...
        LOG.info("G1_LOCOMOTION_XR_HANDOVER_LIVE_V6_7_3_NO_DISK_LOGGING_CLEAN_EXIT")
        LOG.warning(
        ...
        if tv_wrapper is not None:
            ...
            LOG.info(
                "V6.7.3 deterministic TeleVuer shutdown: skipping blocking "
