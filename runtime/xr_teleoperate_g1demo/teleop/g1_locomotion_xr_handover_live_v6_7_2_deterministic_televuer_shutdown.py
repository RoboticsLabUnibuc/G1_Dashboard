...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Synchronized V6.7 diagnostic CSV path. Default: "
            "~/g1_setup_logs/xr_v6_7_2_diag_<timestamp>.csv"
        ),
    )
    return parser
...
def main() -> int:
    ...
    try:
        ...
        LOG.info("G1_LOCOMOTION_XR_HANDOVER_LIVE_V6_7_2_DETERMINISTIC_TELEVUER_SHUTDOWN")
        LOG.warning(
        ...
        diagnostic_path = (
            ...
            / "g1_setup_logs"
            / f"xr_v6_7_2_diag_{time.strftime('%Y%m%d_%H%M%S')}.csv"
        )
        ...
        if tv_wrapper is not None:
            ...
            LOG.info(
                "V6.7.2 deterministic TeleVuer shutdown: skipping blocking "
